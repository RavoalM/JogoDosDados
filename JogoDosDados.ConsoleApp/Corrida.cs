...
namespace JogoDosDados.ConsoleApp
{
    public class Corrida
    {
        ...
        public static decimal ObterAposta()
        {
            Console.Clear();
        ...
        public static void RodadaUsuario()
        {
        ...
        public static void RodadaComputador()
        {
        ...
        public static void MenuUsuario(string nomeUsuario)
        {
            ...
            int resultadoUsuario = Corrida.SortearDado();
        ...
        public static void MenuComputador(string nomeUsuario)
        {
            const int limiteLinhaChegada = 30;
            ...
            int resultadoComputador = Corrida.SortearDado();
            Console.WriteLine("\n================================================");
        ...
        public static void RetornoUser()
        {
        ...
        public static void AvançoComputer()
        {
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("-----------------------");
            Console.WriteLine("EVENTO ESPECIAL: Avanço extra de 3 casas!");
        ...
        public static void RetornoComputer()
        {
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("-----------------------");
            Console.WriteLine("EVENTO ESPECIAL: Retorne 2 casas!");
        ...
        public static void Vitoria(string nomeUsuario, decimal aposta)
        {
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("************************************************");
        ...
        public static void Derrota(string nomeUsuario, decimal aposta)
        {
            Console.ForegroundColor = ConsoleColor.Red;
            Console.Clear();
            Console.WriteLine("************************************************");
        ...
        public static void SaldoZerado()
        {
