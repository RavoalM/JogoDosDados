...
internal class Program
{
    ...
    static void vitoria(string nomeUsuario, decimal aposta)
    {
        Console.Clear();
        Console.ForegroundColor = ConsoleColor.Green;
        Console.WriteLine("************************************************");
    ...
    static void derrotado(string nomeUsuario, decimal aposta)
    {
        Console.ForegroundColor = ConsoleColor.Red;
        Console.Clear();
        Console.WriteLine("************************************************");
